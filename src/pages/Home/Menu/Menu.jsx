...
<div className="hero  bg-base-200 mb-2">
  <div className="hero-content flex-col lg:flex-row">
    <img src="https://demo.cmssuperheroes.com/themeforest/wp-nuvo-elementor/wp-content/uploads/2020/12/img-menu-left.png" className="max-w-lg rounded-lg shadow-2xl" />
    <div>
