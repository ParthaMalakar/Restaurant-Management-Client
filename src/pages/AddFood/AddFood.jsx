...
const AddFood = () => {
    ...
    const handleAdd = (e) => {
        ...
        const order_count = 0;
        const newFood={food_name,food_img,food_category,price,quantity,order_count,made_by,food_origin,description,Add_by}
e.target.reset();
console.log(newFood)
            ...
            <div className="bg-[#4283691a]">
                ...
                <form onSubmit={handleAdd} className=" md:w-3/4 lg:w-1/2 mx-auto">
                    ...
                    <div className="form-control">
                        ...
                        <input type="text"  required name="img" placeholder="Food Name" className="input input-bordered" />
                    </div>
                    <div className="form-control">
                        <label className="label">
